...
const datas = {
  ...
  im: {
    ...
    detail: {
      text: [
        ...
        '将来的には、技術スタックの見直しから始め、動画、音声、テキストファイルへの対応や、UI/UXの向上などもしたいと考えている。',
      ],
      duration: '約2週間',
      since: '2023/9',
      until: '2023/9',
      headcount: 1,
      links: [
        'https://github.com/no-la/image-file-manager',
      ],
      images: [
        {
          type: 'video',
  ...
  dm: {
    ...
    detail: {
      text: [
        ...
        '画面ごとにトランジションを用意したり、ゲームの世界観を元に遊び心のあるUIを作ったり、ステージごとにパーティクルを出したりと、ゲーム全体を通して細かいところにまでこだわって制作した。',
      ],
      duration: '8ヶ月',
      since: '2021/11',
      until: '2022/7',
  ...
  yu: {
    ...
    detail: {
      ...
      headcount: 1,
      links: [
        'https://no-la.github.io/utayomi/',
        'https://github.com/no-la/utayomi',
      ],
      images: [
        {
          type: 'video',
